 ...
 */
export const insertIntoArray = <T extends Y[], Y>(
  array: T,
  index: number,
  item: Y
): T =>
 ...
 */
export const replaceIntoArray = <T extends Y[], Y>(
  array: T,
  index: number,
  item: Y
): T =>
 ...
 */
export const removeIndexArray = <T extends unknown[]>(
  array: T,
  index: number
): T => {
 ...
 */
export const findNextIndex = <T extends unknown[]>(
  array: T,
 ...
 */
export const findPreviousIndex = <T extends unknown[]>(
  array: T,
  predicate: (value: T[number], index: number, arr: T[number][]) => boolean
): number => {
  const currentIndex = array.findIndex(predicate);
 ...
 */
export const findNextInArray = <T extends unknown[]>(
  array: T,
  predicate: (value: T[number], index: number, arr: T[number][]) => boolean
): T[number] => array[findNextIndex(array, predicate)] as T[number];
 ...
 */
export const findPreviousInArray = <T extends unknown[]>(
  array: T,
  predicate: (value: T[number], index: number, arr: T[number][]) => boolean
): T[number] => array[findPreviousIndex(array, predicate)] as T[number];
 ...
 */
export const limitEnd = <T extends unknown[]>(array: T, max: number): T =>
  array.slice(0, max) as T;
 ...
 * @returns a new copy of the array with the length limited
 */
export const limitStart = <T extends unknown[]>(array: T, max: number): T => {
 ...
 */
export const shiftIndexInArray = <T extends unknown[]>(
  array: T,
  initialIndex: number,
  targetIndex: number
): T => {
 ...
 * @returns a new copy of the array with the item moved
 */
export const shiftToNextIndexInArray = <T extends unknown[]>(
  array: T,
  initialIndex: number
): T => {
 ...
 * @returns a new copy of the array with the item moved
 */
export const shiftToPreviousIndexInArray = <T extends unknown[]>(
  array: T,
  initialIndex: number
): T => {
